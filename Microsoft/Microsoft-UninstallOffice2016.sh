...
# Purpose: Uninstall Microsoft Office 2016 apps completely
#
#
# Change Log:
...
APPLICATIONS_TO_CLOSE="Microsoft Word
Microsoft Excel
...
LAUNCHD_ITEMS="com.microsoft.office.licensingV2.helper.plist
...
ROOT_ITEMS="/Library/PrivilegedHelperTools/com.microsoft.office.licensingV2.helper
...
USER_ITEMS="Library/Containers/com.microsoft.errorreporting
...
This includes ALL Outlook mail, calendars, and contacts not stored in Office 365.
...
for AGENT in $LAUNCHD_ITEMS;do
    ...
    clearLaunchDItem "/Library/LaunchDaemons/$AGENT"
